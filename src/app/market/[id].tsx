...
export default function Market(){
    ...
    async function fetchMarket() {
        try {
            ...
            console.log(error)
            Alert.alert("Erro", "Não foi possivel carregar as informação", [
                {
                    text: "OK", 
                    onPress: () => router.back()
                },
    ...
    async function handleOpenCamera(){
        try {
            ...
            if(!granted){
                return Alert.alert("Câmera", "Você precisa habilitar a câmera para ler o QrCode")
            }
